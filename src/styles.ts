...
export const s = StyleSheet.create({
  ...
  /* Las dos fechas del cliente (ronda 3, punto 10). El último contacto va bajo el
     nombre, en relativo, porque es lo que dice quién se está enfriando; la de
     registro va abajo, en chico. */
  cliUltimoContacto: { fontSize: 11, color: C.slate400, marginTop: 2 },
  cliRegistro: { fontSize: 11, color: C.slate400 },
